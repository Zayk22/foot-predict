...
import { Radio, AlertTriangle, Inbox } from 'lucide-react';
      ...
      <div className="space-y-8">
        ...
        {!loading && !error && Object.keys(groupedMatches).length === 0 && (
          <div className="glass rounded-2xl p-10 text-center">
            ...
            <h3 className="text-lg font-semibold text-surface-900 dark:text-surface-100 mb-2">No matches scheduled</h3>
