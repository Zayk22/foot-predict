    ...
    <div className="min-h-screen flex items-center justify-center bg-surface-50 dark:bg-surface-950 p-4">
      ...
      >
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div>
            ...
            <input
              ...
              required
              className="w-full px-4 py-3 rounded-xl bg-surface-100 dark:bg-surface-800 text-surface-900 dark:text-surface-100 outline-none focus:ring-2 focus:ring-accent-500"
        ...
        <p className="text-center text-sm text-surface-500 mt-6">
          ...
          <button onClick={() => router.push('/signup')} className="text-accent-500 hover:text-accent-600 font-medium">
            Sign Up
          </button>
        </p>
      </motion.div>
