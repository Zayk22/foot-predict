...
export default function PredictionsTable() {
  ...
  return (
    <div ref={tableRef} className="glass-strong rounded-2xl p-6 overflow-x-auto">
      <div className="mb-6">
        ...
        <table className="w-full text-left">
          ...
          <tbody>
            {predictions.map((p) => (
              ...
              >
                <td className="py-4 pr-4 text-sm font-medium text-surface-900 dark:text-surface-100">
                ...
                <td className="py-4 pr-4">
                  <span className="inline-block px-2 py-1 text-xs font-medium bg-accent-500/10 text-accent-600 dark:text-accent-400 rounded-full">
                    {p.predicted_outcome}
                  </span>
                </td>
                <td className="py-4 pr-4">
